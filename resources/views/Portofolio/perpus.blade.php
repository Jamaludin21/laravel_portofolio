                        ...
                        <div class="portfolio-details-slider swiper">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src={{ asset('img/portfolio/perpus1.png') }} alt="">
                                </div>

                                <div class="swiper-slide">
                                    <img src={{ asset('img/portfolio/perpus2.png') }} alt="">
                                </div>

                                <div class="swiper-slide">
                                    <img src={{ asset('img/portfolio/perpus3.png') }} alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img src={{ asset('img/portfolio/perpus4.png') }} alt="">
                                </div>

                                <div class="swiper-slide">
                                    <img src={{ asset('img/portfolio/perpus5.png') }} alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            ...
                            <ul>
                                ...
                                <li><strong>Client</strong>: SMP YPII Bungur Bekasi</li>
                                <li><strong>Project date</strong>: 20 Oktober 2022</li>
