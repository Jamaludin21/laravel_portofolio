                        ...
                        <div class="portfolio-details-slider swiper">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src={{ asset('img/portfolio/sensa1.png') }} alt="">
                                </div>

                                <div class="swiper-slide">
                                    <img src={{ asset('img/portfolio/sensa2.png') }} alt="">
                                </div>

                                <div class="swiper-slide">
                                    <img src={{ asset('img/portfolio/sensa3.png') }} alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img src={{ asset('img/portfolio/sensa4.png') }} alt="">
                                </div>

                                <div class="swiper-slide">
                                    <img src={{ asset('img/portfolio/sensa5.png') }} alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            ...
                            <ul>
                                ...
                                <li><strong>Client</strong>: Solo Digital Technopark</li>
                                <li><strong>Project date</strong>: 25 June 2022</li>
                                <li><strong>Project URL</strong>: <a href="https://ecommerce.sensa.id/">E-Commerce</a>
                                </li>
                            </ul>
                        </div>
