                        ...
                        <div class="portfolio-details-slider swiper">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src={{ asset('img/portfolio/eraport1.png') }} alt="">
                                </div>

                                <div class="swiper-slide">
                                    <img src={{ asset('img/portfolio/eraport2.png') }} alt="">
                                </div>

                                <div class="swiper-slide">
                                    <img src={{ asset('img/portfolio/eraport3.png') }} alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img src={{ asset('img/portfolio/eraport4.png') }} alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            ...
                            <ul>
                                ...
                                <li><strong>Project date</strong>: 1 Desember 2022</li>
